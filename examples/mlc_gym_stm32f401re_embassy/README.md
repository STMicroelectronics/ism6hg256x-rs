...
- **Sensor:** ISM6HG256X IMU (accelerometer + gyroscope + MLC-based exercise detection)
...
The ISM6HG256X sensor is connected via I2C1 on PB8/PB9. The MLC event interrupt line is connected to PC0, configured to trigger an external interrupt on rising edge. UART output is routed through PA2 for serial communication.
...
*This README provides a detailed explanation of the embedded Rust program for gym exercise detection on STM32F401RE using the ISM6HG256X sensor and JSON-generated MLC configuration.*
