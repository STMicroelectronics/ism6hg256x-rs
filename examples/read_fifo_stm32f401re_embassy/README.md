...
- **Sensor:** ISM6HG256X IMU (accelerometer + gyroscope + FIFO support)
...
The ISM6HG256X sensor is connected via I2C1 on PB8/PB9. The FIFO watermark interrupt line is connected to PC0, configured to trigger an external interrupt on rising edge. UART output is routed through PA2 for serial communication.
...
*This README explains the embedded Rust program for FIFO-based sensor data streaming from the ISM6HG256X on STM32F401RE using Embassy STM32 HAL.*
