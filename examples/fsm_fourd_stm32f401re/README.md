...
- The sensor is configured by applying a sequence of register writes and delays generated by the **`ucf-tool`** from a JSON file (`lsm6hg256x_four_d.ucf`), which programs the sensor's FSM for gesture detection.
