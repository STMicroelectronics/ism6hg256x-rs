# ISM6HG256X Sensor Data Acquisition on STM32F401RE with IKS4A1 Shield
...
The IKS4A1 shield is mounted on top of the STM32F401RE Nucleo board, providing the ISM6HG256X sensor connected to the microcontroller's I2C1 peripheral on pins PB8 (SCL) and PB9 (SDA). The UART output is routed through PA2 to allow serial communication with a host PC or terminal.
