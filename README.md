...
[crates-badge]: https://img.shields.io/crates/v/ism6hg256x-rs
[crates-url]: https://crates.io/crates/ism6hg256x-rs
[bsd-badge]: https://img.shields.io/crates/l/ism6hg256x-rs
[bsd-url]: https://opensource.org/licenses/BSD-3-Clause

Provides a platform-agnostic, no_std-compatible driver for the ST ISM6HG256X IMU, supporting both I2C and SPI communication interfaces.
...
```rust
let mut sensor = Ism6hg256x::new_i2c(i2c, I2CAddress::I2cAddL, delay);
```
