use super::super::{
    BusOperation, DelayNs, Error, Ism6hg256x, RegisterOperation, SensorOperation, bisync,
...
#[register(address = Reg::FuncCfgAccess, access_type = "Ism6hg256x<B, T, S>", multi_state = true)]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct FuncCfgAccess {
    /// If 1 enables OIS chain full control from the primary interface. Default: 0.
    #[bits(1, default = 0)]
    pub ois_ctrl_from_ui: u8,
    /// Resets auxiliary interface control registers from primary interface (not auto-cleared). Default: 0.
    #[bits(1, default = 0)]
    pub if2_reset: u8,
...
#[register(address = Reg::PinCtrl, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct PinCtrl {
    ...
    #[bits(1, default = 0)]
    pub sdo_pu_en: u8,
    /// Disables pull-up on OCS_aux and SDO_aux pins. Default: 0 (pull-up enabled).
    #[bits(1, default = 0)]
    pub ois_pu_dis: u8,
}
...
#[register(address = Reg::IfCfg, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct IfCfg {
...
#[register(address = Reg::OdrTrigCfg, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::FifoCtrl1, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::FifoCtrl2, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::FifoCtrl3, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::FifoCtrl4, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct FifoCtrl4 {
    ...
    #[bits(3)]
    pub fifo_mode: u8,
    /// Enables FIFO batching of enhanced EIS gyroscope output values. Default: 0 (disabled).
    #[bits(1)]
...
#[register(address = Reg::CounterBdrReg1, access_type = "Ism6hg256x<B, T, MainBank>", order = Inverse)]
...
///
/// Counter batch data rate register 1 (R/W).
#[register(address = Reg::CounterBdrReg1, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::CounterBdrReg2, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::Int1Ctrl, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Int1Ctrl {
...
#[register(address = Reg::Int2Ctrl, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Int2Ctrl {
    ...
    #[bits(1)]
    pub int2_drdy_g: u8,
    /// Enables gyroscope EIS data-ready interrupt on INT2 pin. Default: 0.
    #[bits(1)]
...
#[register(address = Reg::WhoAmI, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct WhoAmI {
...
#[register(address = Reg::Ctrl1, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Ctrl1 {
...
#[register(address = Reg::Ctrl2, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Ctrl2 {
...
#[register(address = Reg::Ctrl3, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Ctrl3 {
...
#[register(address = Reg::Ctrl4, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Ctrl4 {
...
#[register(address = Reg::Ctrl5, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Ctrl5 {
    ...
    #[bits(4, access = RO)]
    not_used0: u8,
    /// Part of auxiliary device static address (bit 0)
    #[bits(1)]
    pub if2_ta0_pid: u8,
}
...
#[register(address = Reg::Ctrl6, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Ctrl6 {
...
#[register(address = Reg::Ctrl7, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Ctrl7 {
...
#[register(address = Reg::Ctrl8, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Ctrl8 {
...
#[register(address = Reg::Ctrl9, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Ctrl9 {
...
#[register(address = Reg::Ctrl10, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Ctrl10 {
...
#[register(address = Reg::CtrlStatus, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::FifoStatus1, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u16, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u16, order = Lsb))]
...
#[register(address = Reg::AllIntSrc, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
///
/// Status register (R)
#[register(address = Reg::StatusReg, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct StatusReg {
    ...
    #[bits(1)]
    pub xlhgda: u8,
    /// Enhanced EIS gyroscope new data available flag
    #[bits(1)]
    pub gda_eis: u8,
    /// OIS chain new data available flag
    #[bits(1)]
    pub ois_drdy: u8,
    /// Reserved bits, read-only
    #[bits(1, access = RO)]
...
#[register(address = Reg::OutTempL, access_type = "Ism6hg256x<B, T, MainBank>")]
pub struct OutTemp(pub i16);

/// OutXYZG (0x22 - 0x27)
///
/// Gyroscope X, Y, Z axis angular rate output (3 x 16-bit two's complement)
#[named_register(address = Reg::OutxLG, access_type = "Ism6hg256x<B, T, MainBank>")]
pub struct OutXYZG {
    pub x: i16,
    pub y: i16,
    pub z: i16,
...
#[named_register(address = Reg::OutxLA, access_type = "Ism6hg256x<B, T, MainBank>")]
pub struct OutXYZA {
    pub x: i16,
    pub y: i16,
    pub z: i16,
...
/// UiOutXYZGOisEis (0x2E - 0x33)
///
/// Gyroscope OIS/EIS output for X, Y, Z axes (3 x 16-bit two's complement)
#[named_register(address = Reg::UiOutxLGOisEis, access_type = "Ism6hg256x<B, T, MainBank>")]
...
/// UiOutXYZAOisHg (0x34 - 0x39)
///
/// Accelerometer OIS/high-g output for X, Y, Z axes (3 x 16-bit two's complement)
#[named_register(address = Reg::UiOutxLAOisHg, access_type = "Ism6hg256x<B, T, MainBank>")]
pub struct UiOutXYZAOisHg {
    pub x: i16,
    pub y: i16,
    pub z: i16,
}
...
#[register(address = Reg::Timestamp0, access_type = "Ism6hg256x<B, T, MainBank>")]
pub struct Timestamp(pub u32);

/// UI_STATUS_REG_OIS (0x44)
///
/// OIS status register (R)
#[register(address = Reg::UiStatusRegOis, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::WakeUpSrc, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::TapSrc, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct TapSrc {
...
#[register(address = Reg::D6dSrc, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct D6dSrc {
...
#[register(address = Reg::StatusControllerMainpage, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::EmbFuncStatusMainpage, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::FsmStatusMainpage, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::MlcStatusMainpage, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::HgWakeUpSrc, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::Ctrl2XlHg, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::Ctrl1XlHg, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::InternalFreq, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::FunctionsEnable, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::HgFunctionsEnable, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::HgWakeUpThs, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::InactivityDur, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
#[derive(PartialEq)]
...
#[register(address = Reg::InactivityThs, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::TapCfg0, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct TapCfg0 {
...
#[register(address = Reg::TapCfg1, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct TapCfg1 {
...
#[register(address = Reg::TapCfg2, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct TapCfg2 {
...
#[register(address = Reg::TapThs6d, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct TapThs6d {
...
#[register(address = Reg::TapDur, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct TapDur {
...
#[register(address = Reg::WakeUpThs, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::WakeUpDur, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::FreeFall, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct FreeFall {
...
#[register(address = Reg::Md1Cfg, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Md1Cfg {
...
#[register(address = Reg::Md2Cfg, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct Md2Cfg {
...
#[register(address = Reg::HaodrCfg, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct HaodrCfg {
...
#[register(address = Reg::EmbFuncCfg, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::UiHandshakeCtrl, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct UiHandshakeCtrl {
    /// Primary interface side request bit for access to UI_IF2_SHARED registers
    #[bits(1)]
    pub ui_shared_req: u8,
    /// Primary interface side acknowledge bit for access to UI_IF2_SHARED registers
    #[bits(1)]
...
/// UI_IF2_SHARED_0 (0x65)
///
/// UI / IF2 shared register 0 (R/W).
/// Volatile byte used as a contact point between primary and secondary interface hosts.
/// Access is mutually exclusive and managed via UI_SHARED_ACK/REQ and IF2_SHARED_ACK/REQ bits.
#[register(address = Reg::UiIf2Shared0, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct UiIf2Shared0 {
    /// Shared 8-bit data between UI and IF2 interfaces.
    #[bits(8)]
    pub ui_if2_shared: u8,
}

/// UI_IF2_SHARED_1 (0x66)
///
/// UI / IF2 shared register 1 (R/W).
/// Volatile byte used as a contact point between primary and secondary interface hosts.
/// Access is mutually exclusive and managed via UI_SHARED_ACK/REQ and IF2_SHARED_ACK/REQ bits.
#[register(address = Reg::UiIf2Shared1, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct UiIf2Shared1 {
    /// Shared 8-bit data between UI and IF2 interfaces.
    #[bits(8)]
    pub ui_if2_shared: u8,
}

/// UI_IF2_SHARED_2 (0x67)
///
/// UI / IF2 shared register 2 (R/W).
/// Volatile byte used as a contact point between primary and secondary interface hosts.
/// Access is mutually exclusive and managed via UI_SHARED_ACK/REQ and IF2_SHARED_ACK/REQ bits.
#[register(address = Reg::UiIf2Shared2, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct UiIf2Shared2 {
    /// Shared 8-bit data between UI and IF2 interfaces.
    #[bits(8)]
    pub ui_if2_shared: u8,
}

/// UI_IF2_SHARED_3 (0x68)
///
/// UI / IF2 shared register 3 (R/W).
/// Volatile byte used as a contact point between primary and secondary interface hosts.
/// Access is mutually exclusive and managed via UI_SHARED_ACK/REQ and IF2_SHARED_ACK/REQ bits.
#[register(address = Reg::UiIf2Shared3, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct UiIf2Shared3 {
    /// Shared 8-bit data between UI and IF2 interfaces.
    #[bits(8)]
    pub ui_if2_shared: u8,
}

/// UI_IF2_SHARED_4 (0x69)
///
/// UI / IF2 shared register 4 (R/W).
/// Volatile byte used as a contact point between primary and secondary interface hosts.
/// Access is mutually exclusive and managed via UI_SHARED_ACK/REQ and IF2_SHARED_ACK/REQ bits.
#[register(address = Reg::UiIf2Shared4, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct UiIf2Shared4 {
    /// Shared 8-bit data between UI and IF2 interfaces.
    #[bits(8)]
    pub ui_if2_shared: u8,
}

/// UI_IF2_SHARED_5 (0x6A)
///
/// UI / IF2 shared register 5 (R/W).
/// Volatile byte used as a contact point between primary and secondary interface hosts.
/// Access is mutually exclusive and managed via UI_SHARED_ACK/REQ and IF2_SHARED_ACK/REQ bits.
#[register(address = Reg::UiIf2Shared5, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct UiIf2Shared5 {
    /// Shared 8-bit data between UI and IF2 interfaces.
    #[bits(8)]
    pub ui_if2_shared: u8,
}
...
/// Controls full scale, LPF bandwidth, output routing, and ODR for EIS gyroscope channel.
#[register(address = Reg::CtrlEis, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct CtrlEis {
    /// Gyroscope full-scale selection for EIS channel (3 bits).
    /// Values 001 to 100 correspond to ±250 to ±2000 dps; 000 is reserved.
    #[bits(3)]
    pub fs_g_eis: u8,
    /// Enables routing gyroscope EIS output to OIS UI output registers (0=disabled, 1=enabled).
    #[bits(1)]
    pub g_eis_on_g_ois_out_reg: u8,
    /// Gyroscope digital LPF_EIS filter bandwidth selection (1 bit).
    #[bits(1)]
    pub lpf_g_eis_bw: u8,
    /// Reserved, read-only bit.
    #[bits(1, access = RO)]
    not_used0: u8,
    /// Gyroscope EIS output data rate selection (2 bits).
    /// 00: off; 01: 1.92 kHz; 10: 960 Hz; 11: reserved.
    #[bits(2)]
    pub odr_g_eis: u8,
}
...
#[named_register(address = Reg::XlHgXOfsUsr, access_type = "Ism6hg256x<B, T, MainBank>")]
#[derive(Default)]
...
/// Expressed as 8-bit two's complement; weight 0.25 g/LSb for FS ≤ ±256g, 0.33 g/LSb for ±320g.
#[register(address = Reg::XlHgYOfsUsr, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
/// Expressed as 8-bit two's complement; weight 0.25 g/LSb for FS ≤ ±256g, 0.33 g/LSb for ±320g.
#[register(address = Reg::XlHgZOfsUsr, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
/// Controls OIS DRDY masking, clamp disable during self-test, and INT2 DRDY routing.
#[register(address = Reg::UiIntOis, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct UiIntOis {
    /// Reserved, read-only (4 bits).
    #[bits(4, access = RO)]
    not_used0: u8,
    /// Disables OIS chain clamp during self-test (0=outputs=8000h, 1=OIS self-test outputs).
    #[bits(1)]
    pub st_ois_clampdis: u8,
    /// Reserved, read-only (1 bit).
    #[bits(1, access = RO)]
    not_used1: u8,
    /// Masks OIS data available signals until filter settling ends (0=enabled, 1=masked).
    #[bits(1)]
    pub drdy_mask_ois: u8,
    /// Enables OIS chain DRDY on INT2 pin from UI interface (priority over other INT2 settings).
    #[bits(1)]
...
/// UI_CTRL1_OIS (0x70)
///
/// OIS configuration register 1 (R/W).
/// Controls auxiliary SPI mode, OIS accelerometer and gyroscope enable, and simulation mode.
#[register(address = Reg::UiCtrl1Ois, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::UiCtrl2Ois, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct UiCtrl2Ois {
    /// Gyroscope OIS full-scale selection (3 bits).
    /// Values 001 to 100 correspond to ±250 to ±2000 dps; 000 reserved.
    #[bits(3)]
    pub fs_g_ois: u8,
    /// Gyroscope OIS digital LPF1 filter bandwidth selection (2 bits).
    #[bits(2)]
    pub lpf1_g_ois_bw: u8,
    /// Reserved, read-only (3 bits).
    #[bits(3, access = RO)]
    not_used0: u8,
}
...
#[register(address = Reg::UiCtrl3Ois, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct UiCtrl3Ois {
    /// Accelerometer OIS full-scale selection (2 bits).
    /// 00=±2g (default), 01=±4g, 10=±8g, 11=±16g.
    #[bits(2)]
    pub fs_xl_ois: u8,
    /// Reserved, read-only (1 bit).
    #[bits(1, access = RO)]
...
#[register(address = Reg::XOfsUsr, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct XOfsUsr {
...
/// Offset added internally to measured acceleration on Y-axis.
/// Expressed as 8-bit two's complement; weight depends on USR_OFF_W in CTRL9.
#[register(address = Reg::YOfsUsr, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct YOfsUsr {
...
/// Offset added internally to measured acceleration on Z-axis.
/// Expressed as 8-bit two's complement; weight depends on USR_OFF_W in CTRL9.
#[register(address = Reg::ZOfsUsr, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
pub struct ZOfsUsr {
...
#[register(address = Reg::FifoDataOutTag, access_type = "Ism6hg256x<B, T, MainBank>")]
#[cfg_attr(feature = "bit_order_msb", bitfield(u8, order = Msb))]
#[cfg_attr(not(feature = "bit_order_msb"), bitfield(u8, order = Lsb))]
...
#[register(address = Reg::FifoDataOutXL, access_type = "Ism6hg256x<B, T, MainBank>")]
...
/// Gyroscope EIS output data rate selection.
#[repr(u8)]
#[derive(Clone, Copy, PartialEq, Default, TryFrom)]
#[try_from(repr)]
pub enum EisGyDataRate {
    /// EIS channel off.
    OdrOff = 0x0,
    /// 1.92 kHz (default).
    #[default]
...
pub enum FifoBatchCntEvent {
    ...
    GyBatch = 0x1,
    /// Enhanced EIS gyroscope batch event.
    GyEisBatch = 0x2,
...
pub enum OisCtrlMode {
    ...
    #[default]
    FromOis = 0x0,
    /// Control from primary interface (UI).
    FromUi = 0x1,
}
